...
ScribeUI.UI.init = function(){
    ...
    this.manager.exportMap = {};
    this.manager.exportMap.logs = function(){return $('#export-logs')};
    this.manager.importMap = {};
    this.manager.importMap.logs = function(){return $('#import-logs')};
    this.poi = {};
